...
Install all dependencies before running the scanner:

```bash
# 1. Install Python dependencies
pip install -r requirements.txt

# 2. Install jscpd (Node.js required)
npm install -g jscpd

# 3. Install Qodana CLI
curl -fsSL https://jb.gg/qodana-cli/install | bash
#    or download manually from https://github.com/JetBrains/qodana-cli/releases
